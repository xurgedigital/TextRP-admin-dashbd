            ...
            {NftData && NftData?.length > 0 ? (
              NftData?.map((ci, i) => (
                <tr key={i} className="text-sm font-normal">
                  ...
                  <td colSpan={2}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam finibus odio
                    lectus, eu mattis nulla laoreet id. Phasellus imperdiet erat risus, sed sagittis
                    justo blandit.
                  </td>
              ...
              <tr className="w-full">
                <td colSpan={4} className="w-full">
                  <div className="text-base font-medium w-full text-center p-8">Loading...</div>
                </td>
              </tr>
            )}
          </tbody>
