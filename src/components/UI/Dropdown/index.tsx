  ...
  return (
    <div ref={dropdownRef} className={`relative  ${className}`}>
      <button
        ...
        className="text-secondary-text  rounded-lg text-base font-normal appearance-none border-[0.5px] bg-gray-bg  border-primary-gray focus:outline-none py-4 px-3 text-center inline-flex justify-between items-center w-full shadow-shadow-primary"
        type="button"
      >
          ...
          {dropdownList?.map((dl, index) => (
            <li key={`dl-${index}`}>
              <div
                ...
                className="block cursor-pointer py-4 px-4 hover:bg-gray-100 font-medium text-sm"
              >
                {dl}
              </div>
            </li>
